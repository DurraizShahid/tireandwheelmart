...
const activityIcons: Record<string, React.ReactNode> = {
  ...
  status_change: <ArrowRightCircle className="h-4 w-4 text-purple-500" />,
  call: <Phone className="h-4 w-4 text-green-500" />,
  conversion: <UserCheck className="h-4 w-4 text-emerald-500" />,
  assignment: <UserCheck className="h-4 w-4 text-orange-500" />,
...
const activityColors: Record<string, string> = {
  ...
  status_change: "border-purple-200 bg-purple-50 dark:border-purple-800 dark:bg-purple-950/30",
  ...
  assignment: "border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/30",
