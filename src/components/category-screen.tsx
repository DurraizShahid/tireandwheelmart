...
const CategoryScreen = ({ categorySlug }: CategoryScreenProps) => {
  ...
  const products = {
    tires: [
      { id: "1", name: "Michelin Pilot Sport 4S", price: "$250", imageSrc: "/images/tire1.png" },
      { id: "2", name: "Pirelli P Zero", price: "$280", imageSrc: "/images/tire2.png" },
      { id: "3", name: "Goodyear Eagle F1", price: "$220", imageSrc: "/images/tire3.png" },
      { id: "4", name: "Continental ExtremeContact", price: "$230", imageSrc: "/images/tire4.png" },
    ],
    brakes: [
      { id: "5", name: "Brembo GT Kit", price: "$2500", imageSrc: "/images/brake1.png" },
      { id: "6", name: "StopTech Sport Kit", price: "$1800", imageSrc: "/images/brake2.png" },
      { id: "7", name: "EBC Yellowstuff Pads", price: "$150", imageSrc: "/images/brake3.png" },
    ],
    suspension: [
      { id: "8", name: "Ohlins Road & Track Coilovers", price: "$3200", imageSrc: "/images/suspension1.png" },
      { id: "9", name: "KW V3 Coilovers", price: "$2800", imageSrc: "/images/suspension2.png" },
      { id: "10", name: "Bilstein B16 PSS10", price: "$2000", imageSrc: "/images/suspension3.png" },
    ],
    engine: [
      { id: "11", name: "APR Stage 1 ECU Tune", price: "$700", imageSrc: "/images/engine1.png" },
      { id: "12", name: "K&N Cold Air Intake", price: "$350", imageSrc: "/images/engine2.png" },
      { id: "13", name: "Akrapovic Exhaust System", price: "$4000", imageSrc: "/images/engine3.png" },
    ],
  };
