          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">$126,843</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">$87.23</div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sales and revenue quarterly breakdown</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
