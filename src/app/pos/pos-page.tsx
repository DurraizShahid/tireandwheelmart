    ...
    <div className="flex h-screen flex-col bg-muted/30 transition-all duration-200">
          ...
          <div className="flex items-center gap-3 border-b bg-card px-4 py-3 shrink-0">
            ...
            <Sheet open={suspendedSheetOpen} onOpenChange={setSuspendedSheetOpen}>
              ...
              <SheetContent side="right" className="w-full sm:w-[400px] p-0">
                <SheetTitle className="sr-only">{t("pos.suspended_sales")}</SheetTitle>
            ...
            <Sheet open={cartSheetOpen} onOpenChange={setCartSheetOpen}>
              ...
              <SheetContent side="right" className="w-full sm:w-[400px] p-0">
                <SheetTitle className="sr-only">{t("pos.cart")}</SheetTitle>
                <CartPanel
                  items={cartItems}
      ...
      <Sheet open={customerSheetOpen} onOpenChange={setCustomerSheetOpen}>
        <SheetContent side="right" className="w-full sm:w-[400px]">
          <SheetTitle className="text-lg font-semibold mb-4">{t("pos.select_customer")}</SheetTitle>
      ...
      <Sheet open={historySheetOpen} onOpenChange={setHistorySheetOpen}>
        <SheetContent side="right" className="w-full sm:w-[400px] p-0">
          <SheetTitle className="sr-only">{t("pos.customer_history")}</SheetTitle>
          {selectedCustomer && (
            <CustomerHistory
